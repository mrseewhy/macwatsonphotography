      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="flex-1 flex items-center">
          <div className="text-left">
            <h2 className="text-3xl font-exo font-bold mb-4">About Me</h2>
            <p className="text-gray-800 font-lato mb-4">
            <strong>ADEDOYIN ADEROMOLA MACWATSON</strong> is an accomplished documentary and Fine art photographer, hailing from Lagos, Nigeria. With a solid academic foundation in Dramatic Arts attained from the prestigious <strong>OBAFEMI AWOLOWO UNIVERSITY, ILE IFE</strong>, she exhibits a profound passion for her craft. Adedoyin&#39;s unwavering dedication lies in the exploration and portrayal of Humanism, Africanism, and the diverse narratives of people of color.
</p>
<p className="text-gray-800 font-lato mb-4">
In addition to her formal education, Adedoyin has undergone specialized training in Textile Design and canvas priming, honing her skills under the tutelage of the renowned artist, Dotun Popoola. The recognition of her exceptional talent is evident through the inclusion of her works in esteemed competitions such as the &#39;500 px&#39; Portrait competition in 2023 and the prestigious <strong>&#39;CAP PRIZE 2023.&#39;</strong>
</p>
<p className="text-gray-800 font-lato mb-4">
